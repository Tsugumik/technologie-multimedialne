...
<head>
    ...
    <title>Rejestracja - <?= htmlspecialchars($lab_title) ?></title>
    ...
    <div class="container">
        <div class="glass-card mx-auto" style="max-width: 450px;">
            <div class="text-center mb-4">
                ...
                <p class="text-muted-custom fs-5 mb-0"><?= htmlspecialchars($lab_title) ?></p>
            </div>
            ...
            <form method="POST">
                ...
                <button type="submit" class="btn btn-primary-custom w-100 py-2 fs-5">Zarejestruj się</button>
