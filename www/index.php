    ...
    <div class="container">
        <div class="glass-card text-center mx-auto" style="max-width: 800px;">
            ...
            <div class="row g-4 justify-content-center">
                ...
                <div class="col-md-6">
                    <a href="/z15" class="btn lab-btn w-100 py-4 fs-4 fw-semibold d-flex flex-column align-items-center text-decoration-none">
                        <span style="font-size: 2.5rem; margin-bottom: 0.5rem;">🤝</span>
                        Projekt Z15 CRM
                    </a>
                </div>
                <div class="col-md-6">
                    <a href="/z16" class="btn lab-btn w-100 py-4 fs-4 fw-semibold d-flex flex-column align-items-center text-decoration-none">
                        <span style="font-size: 2.5rem; margin-bottom: 0.5rem;">📝</span>
                        Projekt Z16 CMS
                    </a>
                </div>
                <div class="col-md-6">
                    <a href="/z17" class="btn lab-btn w-100 py-4 fs-4 fw-semibold d-flex flex-column align-items-center text-decoration-none">
                        <span style="font-size: 2.5rem; margin-bottom: 0.5rem;">💬</span>
                        Projekt Z17 Forum
                    </a>
                </div>
                <div class="col-md-6">
                    <a href="/z18" class="btn lab-btn w-100 py-4 fs-4 fw-semibold d-flex flex-column align-items-center text-decoration-none">
                        <span style="font-size: 2.5rem; margin-bottom: 0.5rem;">🖼️</span>
                        Projekt Z18 Photo Gallery
                    </a>
                </div>
                <div class="col-md-6">
                    <a href="/z20" class="btn lab-btn w-100 py-4 fs-4 fw-semibold d-flex flex-column align-items-center text-decoration-none">
                        <span style="font-size: 2.5rem; margin-bottom: 0.5rem;">📍</span>
                        Projekt Z20 Ogłoszenia + GIS
                    </a>
                </div>
            </div>
